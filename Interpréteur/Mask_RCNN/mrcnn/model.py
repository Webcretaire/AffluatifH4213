...
class MaskRCNN():
    ...
    def unmold_detections_only(self, detections, mrcnn_mask, original_image_shape,
                          image_shape, window, filterClasses):
        """Reformats the detections of one image from the format of the neural
        network output to a format suitable for use in the rest of the
        application.
    ...
    def detect_only(self, images, classIdsFilter, verbose=0):
        ...
        for i, image in enumerate(images):
            final_rois, final_class_ids, final_scores, final_masks =\
                self.unmold_detections_only(detections[i], mrcnn_mask[i],
                                       image.shape, molded_images[i].shape,
                                       windows[i], classIdsFilter)
            print("ids : ")
            print(*final_class_ids, sep='\n')
            results.append({
                "rois": final_rois,
